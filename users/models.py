...
class UserProfile(models.Model):
    ...
    gender = models.BooleanField(_('gender'), help_text='female is false, male is true', blank=True, null=True)
    province = models.CharField('province', max_length=100, null=True, blank=True)
...
class Device(models.Model):
    ...
    device_uuid = models.UUIDField(_('Devices UUID'), null=True)
